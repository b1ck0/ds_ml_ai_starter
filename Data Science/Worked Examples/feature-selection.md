...
DS-3 ([Collinearity & Keeping Features Minimal](collinearity.md)) caught one obvious case of feature
...
[the splitting/leakage chapter](train-valid-holdout-split.md) — the scaler lives *inside* the
