...
([classification-titanic.md](classification-titanic.md)). That loop doesn't scale: every new dataset
...
[classification-titanic.md](classification-titanic.md) (`seaborn.load_dataset("titanic")`,
