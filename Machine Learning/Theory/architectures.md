...
[ML-1: Neural Network Fundamentals](neural-network-fundamentals.md) built the base unit — a neuron,
...
Next: [ML-3 — Theory: Representations](representations.md) picks up where "what shape is the raw
