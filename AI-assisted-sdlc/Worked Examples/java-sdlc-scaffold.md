...
[SPEC-SDLC-1 (Theory)](../Theory/theory.md) named four scaffolding primitives an agentic coding
...
[`Local Environment Setup/code/hello-java/pom.xml`](../Local%20Environment%20Setup/code/hello-java/pom.xml):
...
in [SPEC-SDLC-1](../Theory/theory.md) is the same one that governed the writing of every chapter in
