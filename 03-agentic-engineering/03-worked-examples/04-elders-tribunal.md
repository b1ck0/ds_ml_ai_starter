...
see [the MCP chapter's environment box](01-mcp-database-query-layer.md#2-the-database--a-seeded-deterministic-sqlite-file)):
...
[mcp-database-query-layer.md Section 5](01-mcp-database-query-layer.md#5-wiring-an-llm-client--key-gated-separate-from-the-runnable-path)):
...
[the MCP chapter](01-mcp-database-query-layer.md) both practised (secrets in env vars, never in code)
