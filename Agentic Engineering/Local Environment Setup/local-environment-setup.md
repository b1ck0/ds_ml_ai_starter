...
[`theory.md`](../Theory/theory.md) (SPEC-AGENT-1) explained *why* an agent needs RAG and MCP: LLMs are
...
If you've read [`Data Science/Local Environment Setup/local-environment-setup.md`](../../Data%20Science/Local%20Environment%20Setup/local-environment-setup.md)
...
Next: [SPEC-AGENT-2](../Worked%20Examples/mcp-database-query-layer.md) builds a real MCP server with
